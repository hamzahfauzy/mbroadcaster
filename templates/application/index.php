                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="form-group">
                                    <label for="">SMTP Mail</label>
                                    <input type="email" name="app[smtp_email]" class="form-control" value="<?=$data->smtp_email?>">
                                </div>
                                <div class="form-group">
                                    <label for="">SMTP Password</label>
                                    <input type="password" name="app[smtp_password]" class="form-control" value="<?=$data->smtp_password?>">
                                </div>
                                <div class="form-group">
                                    <label for="">SMTP Host</label>
                                    <input type="text" name="app[smtp_host]" class="form-control" value="<?=$data->smtp_host?>">
                                </div>
                                <div class="form-group">
                                    <label for="">SMTP Port</label>
                                    <input type="number" name="app[smtp_port]" class="form-control" value="<?=$data->smtp_port?>">
                                </div>
                                <div class="form-group">
